import{h as d,m as s,D as c,t as p,b}from"./iframe-DfANLok6.js";import"./nuxeo-document-picker-DhbUpbp2.js";import{I as m}from"./nuxeo-i18n-behavior-DkDjknqP.js";import"./preload-helper-Dp1pzeXC.js";import"./render-status-DgSWxHM4.js";import"./iron-flex-layout-Cy57WvA0.js";import"./iron-collapse-B1KRLpU1.js";import"./iron-resizable-behavior-AZ17E4LT.js";import"./nuxeo-search-form-layout-ZvxkAi2L.js";import"./nuxeo-layout-CRkOTeK9.js";import"./nuxeo-search-results-layout-DGJuiFqk.js";import"./nuxeo-dialog-DRutOyFJ.js";import"./paper-material-styles-CVTaxaU1.js";import"./shadow-CZKJlY6X.js";import"./paper-ripple-CvfHxnYa.js";import"./iron-a11y-keys-behavior-CXq8UWKK.js";import"./paper-inky-focus-behavior-rjTRkVyf.js";import"./neon-animation-runner-behavior-DA6rB6qM.js";import"./default-theme-sVFU976S.js";import"./typography-Dsqr7jdM.js";import"./roboto-AfkCeElV.js";import"./templatizer-behavior-Dh-bkegA.js";import"./paper-icon-button-BnBB_cCA.js";import"./iron-icon-Bt9a3Rhq.js";/**
@license
...
See the License for the specific language governing permissions and
limitations under the License.
*/{class r extends s([m],Nuxeo.Element){static get template(){return d`
        ...
        <div id="editor"></div>
      `}static get is(){return"nuxeo-html-editor"}static get properties(){return{value:{type:String,notify:!0},placeholder:{type:String,value:"Type here..."},readOnly:{type:Boolean,value:!1,reflectToAttribute:!0},_editor:{type:Object}}}static get observers(){return["_valueChanged(value, _editor)","_readOnlyChanged(readOnly, _editor)"]}static get importMeta(){return import.meta}ready(){if(super.ready(),!this.hasAttribute("dir")){const e=document.documentElement.getAttribute("dir");this.setAttribute("dir",e)}const{placeholder:l,readOnly:t}=this,i={toolbar:"#toolbar"};this._editor=new Quill(this.$.editor,{theme:"snow",modules:i,placeholder:l,readOnly:t}),this.getAttribute("dir")==="rtl"&&(this._editor.format("align","right"),this._editor.format("direction","rtl")),this._editor.on("text-change",()=>{this._debouncer=c.debounce(this._debouncer,p.after(200),()=>this._updateValue())})}_updateValue(){this._internalChange=!0,this.value=this._editor.getSemanticHTML(),this._internalChange=!1}_valueChanged(){if(this._editor&&!this._internalChange){const l=this._editor.clipboard.convert({html:this.value});this._editor.setContents(l,this.readOnly?Quill.sources.SILENT:Quill.sources.USER),this._editor.setSelection(0,Quill.sources.SILENT)}}_readOnlyChanged(){this._editor&&(this._editor.enable(!this.readOnly),this._editor.getModule("toolbar").container.style.display=this.readOnly?"none":"")}_onImageUpload(){this.$.qlImage.click()}_onSearchImage(){this.$.picker.open()}_onPickerSelected(l){const t=l.detail&&l.detail.selectedItems;if(t){const i=t.filter(e=>e.properties["file:content"]&&e.properties["file:content"].data).map(e=>`<img src="${e.properties["file:content"].data}">`).join(`
`);this._editor.clipboard.dangerouslyPasteHTML(this._editor.getSelection(!0).index,i),this._editor.focus()}}}customElements.define(r.is,r)}const R={title:"UI/nuxeo-html-editor"},o={render:()=>b`
    <style>
      .htmlEditor {
        margin: 20px;
  ...
  `};var n,q,a;o.parameters={...o.parameters,docs:{...(n=o.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      .htmlEditor {
        margin: 20px;
  ...
  \`
}`,...(a=(q=o.parameters)==null?void 0:q.docs)==null?void 0:a.source}}};const U=["NuxeoHtmlEditor"];export{o as NuxeoHtmlEditor,U as __namedExportsOrder,R as default};
