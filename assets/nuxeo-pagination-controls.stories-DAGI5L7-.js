...
*/const r=p`<iron-iconset-svg name="av" size="24">
<svg><defs>
...
*/{class a extends n([l],Nuxeo.Element){static get template(){return p`
        <style>
          :host {
            display: block;
          }
      ...
      `}static get is(){return"nuxeo-pagination-controls"}static get properties(){return{page:{type:Number,value:1,notify:!0},numberOfPages:Number}}_previous(){this.page--}_next(){this.page++}_first(){this.page=1}_last(){this.page=this.numberOfPages}_isFirst(t){return t===1}_isLast(t){return t===this.numberOfPages}_computePageOptions(t){return Array.from({length:t},(c,s)=>s+1)}_computeLimitForOptions(t){const c=Nuxeo&&Nuxeo.UI&&Nuxeo.UI.config&&Nuxeo.UI.config.pagination&&Nuxeo.UI.config.pagination.nuxeoSelectOptions&&Nuxeo.UI.config.pagination.nuxeoSelectOptions.listingMaxItems?Nuxeo.UI.config.pagination.nuxeoSelectOptions.listingMaxItems:1e3;return!(t>c)}}customElements.define(a.is,a),Nuxeo.PaginationControls=a}const U={title:"UI/nuxeo-pagination-controls"},h={args:{numberOfPages:5},render:a=>o`
    <style include="nuxeo-styles">
      nuxeo-pagination-controls {
        margin: 2rem;
      }
    </style>
    <nuxeo-pagination-controls page="1" number-of-pages="${a.numberOfPages}"> </nuxeo-pagination-controls>
  `};var i,e,v;h.parameters={...h.parameters,docs:{...(i=h.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    numberOfPages: 5
  },
  render: args => html\`
  ...
  \`
}`,...(v=(e=h.parameters)==null?void 0:e.docs)==null?void 0:v.source}}};const E=["NuxeoPagination"];export{h as NuxeoPagination,E as __namedExportsOrder,U as default};
