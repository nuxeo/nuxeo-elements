import{L as s}from"./lists.data-Cg1ey1re.js";import{h as U,m as F,R as z,b as D}from"./iframe-DfANLok6.js";import"./iron-data-table-CzZ3X19C.js";import"./nuxeo-document-thumbnail-DxmjOU1p.js";import"./nuxeo-date-DdF4XuiH.js";import"./nuxeo-date-picker-CXC9AEsZ.js";import{I as P}from"./iron-resizable-behavior-AZ17E4LT.js";import{F as H}from"./nuxeo-filters-behavior-BwjeSQ5d.js";import"./iron-icon-Bt9a3Rhq.js";import"./nuxeo-i18n-behavior-DkDjknqP.js";import"./nuxeo-user-avatar-4t6XL0nA.js";import"./nuxeo-tooltip-D6ydFGfA.js";import"./documents.data-BM_UplYo.js";import"./v4-BT9YOjd5.js";import"./image01-_wyEfMQE.js";import"./preload-helper-Dp1pzeXC.js";import"./iron-validatable-behavior-D22XWMWB.js";import"./nuxeo-page-provider-display-behavior-oT_nqsn5.js";import"./templatizer-behavior-Dh-bkegA.js";import"./render-status-DgSWxHM4.js";import"./nuxeo-dialog-DRutOyFJ.js";import"./iron-flex-layout-Cy57WvA0.js";import"./paper-material-styles-CVTaxaU1.js";import"./shadow-CZKJlY6X.js";import"./paper-ripple-CvfHxnYa.js";import"./iron-a11y-keys-behavior-CXq8UWKK.js";import"./paper-inky-focus-behavior-rjTRkVyf.js";import"./neon-animation-runner-behavior-DA6rB6qM.js";import"./default-theme-sVFU976S.js";import"./typography-Dsqr7jdM.js";import"./roboto-AfkCeElV.js";import"./paper-icon-button-BnBB_cCA.js";import"./iron-icons-Gq0N1TWG.js";import"./iron-iconset-svg-5-aE6F5a.js";import"./paper-input-B8T425Tx.js";import"./paper-input-behavior-DGBlyaCy.js";import"./paper-checkbox-J2J5-AY4.js";import"./paper-checked-element-behavior-BrE1EYlL.js";import"./paper-dialog-scrollable-cZKEOOLz.js";import"./shadow-fPN8eZ5U.js";import"./nuxeo-widget-validation-behavior-cLtHj9CV.js";import"./nuxeo-checkmark-hJpRrYeJ.js";import"./nuxeo-icons-Bm09xz8u.js";import"./nuxeo-draggable-list-behavior-B1uVO71n.js";import"./nuxeo-format-behavior-DCZ67kVR.js";import"./moment-with-locales-v-Wg38Ha.js";/**
@license
...
*/{class e extends F([z,P,H],Nuxeo.Element){static get template(){return U`
      ...
      `}static get is(){return"nuxeo-user-tag"}static get properties(){return{user:Object,disabled:{type:Boolean,value:!1},fetchAvatar:{type:Boolean,value:!1},_currentUser:{type:Object},maxCharacters:{type:Number,value:null}}}_isEntity(t){return t&&t["entity-type"]&&(t["entity-type"]==="user"||t["entity-type"]==="document"&&t.type==="user")&&t.properties}_id(t){if(t)return t.properties&&(t.properties.username||t.properties["user:username"])||t.id||t.uid||t.replace("user:","")}_name(t){let n;if(this._isEntity(t)){const r=t.properties.firstName||t.properties["user:firstName"],i=t.properties.lastName||t.properties["user:lastName"],a=t.properties.email||t.properties["user:email"],l=t.properties.username||t.properties["user:username"];n=[r,i].join(" ").trim()||a||l||this._id(t)}else n=this._id(t);return this.maxCharacters&&n&&n.length>this.maxCharacters?`${n.substring(0,this.maxCharacters)}...`:n}_email(t){if(this._isEntity(t)){const n=t.properties.email||t.properties["user:email"];return n!==this._id(t)?n:""}return""}_href(t){return this.urlFor("user",this._id(t))}_hasLink(t,n,r){const i=this._id(n)==="system",a=this.hasAdministrationPermissions(r);return!(t||i||!a)}_preventPropagation(t){t.stopPropagation()}_getUserTagClass(t){const n=this._name(t);return/\s/.test(n)?"user-tag-wrap":"user-tag-nowrap"}_calculateElementWidth(t){const n=getComputedStyle(t),r=parseFloat(n.paddingLeft)+parseFloat(n.paddingRight),i=parseFloat(n.borderLeftWidth)+parseFloat(n.borderRightWidth),a=t.offsetWidth-t.clientWidth;return t.offsetWidth-r-i-a}_getHTMLRootNode(t){let n=t;for(;n.parentNode instanceof DocumentFragment;)n=n.parentNode.host;return n.parentNode}connectedCallback(){if(super.connectedCallback(),!this.hasAttribute("dir")){const t=document.documentElement.getAttribute("dir");this.setAttribute("dir",t)}this.addEventListener("dom-change",this._layout),this.addEventListener("iron-resize",this._layout)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("dom-change",this._layout),this.removeEventListener("iron-resize",this._layout)}_layout(){if(this&&this.parentNode){const t=this,n=this._getHTMLRootNode(t);let r=this._calculateElementWidth(n);const i=Array.from(n.children),a=Array.from(t.shadowRoot.querySelectorAll(".user-avatar")),l=a[0].offsetWidth,q=a.length*l,B=i.reduce((f,g)=>(g!==this&&!g.shadowRoot&&(f+=this._calculateElementWidth(g)),f),0);r-=B+q;const h=this.shadowRoot.querySelector(".username-container");h&&r>0&&h.setAttribute("style",`max-width:${r}px`)}}}customElements.define(e.is,e),Nuxeo.UserTag=e}const o=e=>D`
    <nuxeo-data-table
      .items="${e.data}"
      ?editable="${e.editable}"
...
}`,...(R=(W=b.parameters)==null?void 0:W.docs)==null?void 0:R.source}}};const qe=["Empty","Basic","EditableAndOrderable","Settings","Selectable","Complex"];export{m as Basic,b as Complex,u as EditableAndOrderable,d as Empty,c as Selectable,p as Settings,qe as __namedExportsOrder,je as default};
