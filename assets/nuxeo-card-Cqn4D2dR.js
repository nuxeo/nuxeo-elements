import"./iron-collapse-Q03AhJj8.js";import"./iron-flex-layout-CQAobW0V.js";import"./iron-icon-lX3uy4jx.js";import"./iron-iconset-svg-bEbhiue4.js";import{h as c,m as v}from"./iframe-T5hUCbnt.js";import{I as i}from"./iron-resizable-behavior-BJTBE6_U.js";/**
@license
...
*/const d=c`<iron-iconset-svg name="hardware" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(d.content);/**
@license
...
*/{class e extends v([i],Nuxeo.Element){static get template(){return c`
        <style>
          :host {
            display: block;
      ...
      `}static get is(){return"nuxeo-card"}static get properties(){return{icon:{type:String,value:null},heading:{type:String,value:null},collapsible:{type:Boolean,value:!1,reflectToAttribute:!0},opened:{type:Boolean,value:!1,reflectToAttribute:!0}}}connectedCallback(){if(super.connectedCallback(),!this.hasAttribute("dir")){const h=document.documentElement.getAttribute("dir");this.setAttribute("dir",h)}}_hasHeading(h,t,a){return h||t||a}_getHeadingTabindex(h){return h?"0":"-1"}_opened(h,t){return!t||h}_toggleKeydown(h){if(h&&h.type==="keydown"){const{key:t}=h;if(t!=="Enter"&&t!==" "&&t!=="Spacebar")return;h.preventDefault(),h.stopPropagation(),this._toggle()}}_toggle(){this.collapsible&&(this.opened=!this.opened,this.$$("iron-collapse")&&this.$$("iron-collapse").addEventListener("transitionend",h=>{this.dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0,composed:!0})),this.removeEventListener("transitionend",h)}))}_toggleIcon(h){return`hardware:keyboard-arrow-${h?"up":"down"}`}}customElements.define(e.is,e),Nuxeo.Card=e}
