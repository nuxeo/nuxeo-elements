import{h as a,P as n,m as s}from"./iframe-DfANLok6.js";import"./default-theme-sVFU976S.js";import"./iron-flex-layout-Cy57WvA0.js";import{P as d}from"./paper-checked-element-behavior-BrE1EYlL.js";import{a as c}from"./render-status-DgSWxHM4.js";import{I as p,a as u}from"./iron-menu-behavior-BqEGeEci.js";import{I as h,a as b}from"./iron-validatable-behavior-D22XWMWB.js";import{I as m}from"./nuxeo-i18n-behavior-DkDjknqP.js";import{W as f}from"./nuxeo-widget-validation-behavior-cLtHj9CV.js";/**
@license
...
See the License for the specific language governing permissions and
limitations under the License.
*/{class e extends s([v],Nuxeo.Element){static get template(){return a`
        <style>
          :host {
            display: block;
            position: relative;
      ...
      `}static get is(){return"nuxeo-directory-radio-group"}static get properties(){return{selectedItem:{type:Object,notify:!0},value:{type:String,notify:!0,observer:"_updateSelected"},_selected:String}}_updateItem(t){t.detail&&t.detail.value&&(this.set("selectedItem",this._entries[t.detail.value.dataIndex]),this.set("value",this.idFunction(this.selectedItem)))}_updateSelected(){this.value&&this.value.length>0&&this.value!==this._selected&&(this._selected=this.value),this._entries&&this._entries.forEach(t=>this._isChecked(t))}_getValidity(){const t=!this.required||!!this.value;return t?this._clearDefaultRequiredError():this._applyDefaultRequiredError(),t}_ariaValidationControl(){return this.$.group}_isChecked(t){const o=this.value?this.value:this.selectedItem;return o&&this.idFunction(o)===this.idFunction(t)?(this._selected=this.idFunction(t),!0):!1}}customElements.define(e.is,e),Nuxeo.DirectoryRadioGroup=e}const F=[{absoluteLabel:"Arabic",computedId:"ar",directoryName:"language",displayLabel:"Arabic","entity-type":"directoryEntry",id:"ar",label:"Arabic",obsolete:0,ordering:1e7,properties:{id:"ar",label:"Arabic",obsolete:0,ordering:1e7}},{absoluteLabel:"Chinese",computedId:"zh",directoryName:"language",displayLabel:"Chinese","entity-type":"directoryEntry",id:"zh",label:"Chinese",obsolete:0,ordering:1e7,properties:{id:"zh",label:"Chinese",obsolete:0,ordering:1e7}},{absoluteLabel:"English",computedId:"en",directoryName:"language",displayLabel:"English","entity-type":"directoryEntry",id:"en",label:"English",obsolete:0,ordering:1e7,properties:{id:"en",label:"English",obsolete:0,ordering:1e7}},{absoluteLabel:"French",computedId:"fr",directoryName:"language",displayLabel:"French","entity-type":"directoryEntry",id:"fr",label:"French",obsolete:0,ordering:1e7,properties:{id:"fr",label:"French",obsolete:0,ordering:1e7}}];export{F as D};
