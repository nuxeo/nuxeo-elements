...
(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f(); } else if (typeof define === 'function' && define.amd) { define([], f); } else { let g; if (typeof window !== 'undefined') { g = window; } else if (typeof global !== 'undefined') { g = global; } else if (typeof self !== 'undefined') { g = self; } else { g = this; } g.selectivity = f(); } }(() => {
   ...
   */
       ...
       */
          ...
          /**
       * Announces the highlighted item to screen readers.
       *
       * @private
   ...
   */
       ...
       */
          error(options) {
            return (
              `<div class="selectivity-error">${options.escape ? escape(options.message) : options.message
              }</div>`
            );
          },
       ...
       */
          noResults(options) {
            return (
              `<div class="selectivity-error" aria-live="polite">${options.term ? Selectivity.Locale.noResultsForTerm(options.term) : Selectivity.Locale.noResults
              }</div>`
            );
          },
       ...
       */
          singleSelectedItem(options) {
            return (
              `<span class="selectivity-single-selected-item" data-item-id="${escapeHTML(options.id)}">${options.removable ? '<a class="selectivity-single-selected-item-remove"><i class="fa fa-remove"></i></a>' : ''
      ...
      const options = {
        ...
        templates: {
          ...
          singleSelectedItem: (opts) => (
            `<span class="selectivity-single-selected-item" data-item-id="${escapeHTML(opts.id)}">${opts.removable ?
