      ...
      65: [
        function(_dereq_, module, exports) {
              ...
              assign(
                {
                  ...
                  positionDropdown(el, selectEl) {
                    ...
                    const openUpwards =
                      rect.bottom + dropdownHeight > window.innerHeight && rect.top - dropdownHeight > 0;
          ...
          var callSuper = Selectivity.inherits(MultipleInput, Selectivity, {
            ...
            add(item) {
              ...
              if (this._value.indexOf(id) === -1) {
                ...
                if (itemIsId && this.options.initSelection) {
                  this.options.initSelection([id], (data) => {
                    if (this._value.indexOf(id) > -1) {
             ...
             */
            _updateInputWidth() {
              const inputContent = this.input.value || (!this._data.length && this.options.placeholder) || '';
      ...
      74: [
        function(_dereq_, module, exports) {
          ...
          function defaultTokenizer(input, selection, createToken, options) {
            ...
            function hasToken(input) {
              return input ? separators.some((separator) => input.indexOf(separator) > -1) : false;
            }
      ...
      76: [
        function(_dereq_, module, exports) {
          ...
          Selectivity.inherits = function(SubClass, SuperClass, prototype) {
            SubClass.prototype = assign(Object.create(SuperClass.prototype), { constructor: SubClass }, prototype);
        ...
        function(_dereq_, module, exports) {
            ...
            resultItem(options) {
              return (
                ...
                ` data-item-id="${escape(options.id)}">${escape(options.text)}${
                  options.submenu ? '<span class="selectivity-submenu-icon fa fa-chevron-right"></span>' : ''
                }</div>`
              );
            },
          ...
          `;
            ...
            singleSelectedItem(options) {
              return `${'<span class="selectivity-single-selected-item" ' + 'data-item-id="'}${escape(options.id)}">${
                options.removable
      ...
      81: [
        function(_dereq_, module, exports) {
          ...
          module.exports = function(el, selector) {
            const method = el.matches || el.webkitMatchesSelector || el.mozMatchesSelector || el.msMatchesSelector;
...
});
{
   ...
   */
  class SelectivityElement extends mixinBehaviors(
    ...
    connectedCallback() {
        ...
        templates: {
          ...
          singleSelectedItem: (opts) =>
            `${'<span class="selectivity-single-selected-item" ' + 'data-item-id="'}${escapeHTML(opts.id)}">${
              opts.removable
                ? '<a class="preserve-white-space selectivity-single-selected-item-remove">' +
          ...
          multipleSelectedItem: (opts) => {
            ...
            return `<span class="selectivity-multiple-selected-item${extraClass}"
              ...
              opts.removable
                ? '<a class="preserve-white-space selectivity-multiple-selected-item-remove">' +
                  '<span class="selectivity-remove"></span>' +
                  '</a>'
                : ''
            }${this.selectionFormatter(opts.item || opts)}</span>`;
      ...
      options.query = (query) => {
        ...
        // debounce requests
        this._debouncer = Debouncer.debounce(this._debouncer, timeOut.after(this.frequency), () => {
          this._query(query);
        });
      };
      ...
      Selectivity.Locale = {
        get loading() {
          return self.i18n('selectivity.loading');
        },
        get loadMore() {
          return self.i18n('selectivity.loadMore');
        },
        get noResults() {
          return self.i18n('selectivity.noResults');
        },
        ...
        (entries) => {
          if (entries && entries.length > 0) {
            ...
            if (entry.intersectionRatio === 0) {
              // if the ratio is equal to 0, then the widget is outside the viewport
