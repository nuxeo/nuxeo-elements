    ...
    static get template() {
      return html`
        <template id="header">
          ...
          <div title="[[column.name]]" hidden$="[[column.filterBy]]" role="columnheader" style="flex: 1 1 70px; min-width: 70px;
          max-width: 120px; overflow: hidden; text-overflow: ellipsis; text-align: start;">[[column.name]]</div>
        </template>
      `;
    }
