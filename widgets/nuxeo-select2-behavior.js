...
export const Select2Behavior = {
  ...
  _initSelect2: function(el) {
    ...
    jQuery(el).on('select2-selecting', this._handleSelection.bind(this));
  ...
  // XXX: workaround for: https://github.com/select2/select2/issues/2264
  _handleSelection: function(e) {
    if (this.multiple && this.stayOpenOnSelect && this.minChars > 0){
      e.preventDefault();
      var target =  jQuery(this._el);
